...
public class UserService {
    ...
    public List<SimpleUserRecordDTO> getUserByCity(String userCity) {
        
        List<UserModel> userModelList = userRepository.findAllByCityContainingIgnoreCase(userCity);
    ...
    public SimpleUserRecordDTO updateUser(UpdateUserDTO updateUserDTO) {
        ...
        // Converter para uma entidade de dominio
