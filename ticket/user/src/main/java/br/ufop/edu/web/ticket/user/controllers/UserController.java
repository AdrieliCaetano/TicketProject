...
@RestController
@AllArgsConstructor
@RequestMapping("/users") // Requisição base
public class UserController {
    ...
    public ResponseEntity<List<SimpleUserRecordDTO>> getByCity (@PathVariable(value = "city")  String userCity) {

        List<SimpleUserRecordDTO> list = userService.getUserByCity(userCity);
        return ResponseEntity.ok(list);
    ...
    public ResponseEntity<SimpleUserRecordDTO> updateCreditCard(@RequestBody UpdateUserCreditCardDTO updateUserCreditCardDTO) {
